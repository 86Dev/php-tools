...
abstract class BoolHelper
{
	...
	{
		return in_array(mb_strtolower((string)$string), static::$true_strings, true);
	}
	...
	{
		return empty($string) || in_array(mb_strtolower($string), static::$false_strings, true);
	}
}
