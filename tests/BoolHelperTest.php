...
final class BoolHelperTest extends TestCase
{
	...
	public function testIsTrueString()
	{
		foreach ($this->true_strings as $string)
		{
			...
			// $this->assertTrue(BoolHelper::is_true_string($up = mb_strtoupper($string)), "'$up' is false, should be true.");
		}
		foreach ($this->false_strings as $string)
		{
			$this->assertFalse(BoolHelper::is_true_string($string), "'$string' is true, should be false.");
			// $this->assertFalse(BoolHelper::is_true_string($up = mb_strtoupper($string)), "'$up' is true, should be false.");
		}
	}
	...
	public function testToBool()
	{
		foreach ($this->true_strings as $string)
		{
			...
			// $this->assertTrue(BoolHelper::to_bool($up = mb_strtoupper($string)), "'$up' is false, should be true.");
		}
		...
		foreach ($this->false_strings as $string)
		{
			...
			// $this->assertFalse(BoolHelper::to_bool($up = mb_strtoupper($string)), "'$up' is true, should be false.");
		}
